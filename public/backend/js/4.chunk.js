...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_post_trash_vue__ = __webpack_require__(413);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_72045d5c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_post_trash_vue__ = __webpack_require__(470);
    ...
    methods: {
        ...
        getCategorys: function getCategorys() {
            ...
            _util2.default.ajax.get('/backend/categories', {
                ...
                var res = response.data;
                if (res.status === 200) {
                    res.list.data.splice(0, 0, { id: 0, name: '全部', hidden: true, pid: 0 });
        ...
        setTopCategorys: function setTopCategorys() {
            ...
            categorys.splice(0, 0, { id: 0, name: '全部', hidden: true, pid: 0 });
